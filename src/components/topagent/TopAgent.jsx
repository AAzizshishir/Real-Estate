const agents = [
  {
    id: 1,
    name: "Sarah Johnson",
    image: "https://i.ibb.co/xXnR2gV/agent1.jpg",
    sales: 120,
    rating: 4.9,
  },
  {
    id: 2,
    name: "Michael Lee",
    image: "https://i.ibb.co/Y8m5V7b/agent2.jpg",
    sales: 95,
    rating: 4.8,
  },
  {
    id: 3,
    name: "Ayesha Khan",
    image: "https://i.ibb.co/fY7ZXxG/agent3.jpg",
    sales: 85,
    rating: 4.7,
  },
  {
    id: 4,
    name: "David Kim",
    image: "https://i.ibb.co/LZxXyRH/agent4.jpg",
    sales: 75,
    rating: 4.6,
  },
];
